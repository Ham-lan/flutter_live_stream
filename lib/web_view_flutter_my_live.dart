...
//
// void main() => runApp(const MaterialApp(home: WebViewLiveStream()));
//
...
//   const WebViewLiveStream({super.key});
//
//   @override
//   State<WebViewLiveStream> createState() => _WebViewLiveStreamState();
// }
//
// class _WebViewLiveStreamState extends State<WebViewLiveStream> {
...
//         Uri.parse('https://192.168.0.204:5000/predict'),
//
//         headers: {
...
//       ..loadRequest(
//           Uri.parse(
//               'https://192.168.0.204:5000/predict',
//
//           )
//       );
//
